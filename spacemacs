...
values."
  (setq-default
   ...
   dotspacemacs-excluded-packages '(smartparens ensime)
...
`dotspacemacs/user-config' first."
  ...
  ;; stolen from https://github.com/syl20bnr/spacemacs/issues/2222
  (defun copy-to-clipboard ()
    ...
    (if (display-graphic-p)
      ...
      (if (region-active-p)
          (progn
            (shell-command-on-region (region-beginning) (region-end) "xclip -sel c &> /dev/null")
